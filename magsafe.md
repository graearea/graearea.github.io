...
<button onclick="addToBasket('price_1TJXItAhb23PF7gKrcoINtHn', 'Magsafe Phone Mount', 20, 'Fixed')">Add to basket – £20 + £3 P&P</button>
<button onclick="addToBasket('price_1TJXItAhb23PF7gKCtxVKoZs', 'Magsafe Phone Mount', 25, 'Swivel')">Add to basket – £25 + £3 P&P</button>

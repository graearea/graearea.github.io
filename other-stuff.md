...
![cup](https://img.uberniche.co.uk/no-cup.jpeg)<br/>
to 10000m^2 contact (lol)
![no-cup](https://img.uberniche.co.uk/cup.jpeg)<br/>
These fit into the crappy Spa and Motamec sockets to increase friction and adjustability<br/>
£15 + £4 P&P (or free with any of my mirror mounts)

<button onclick="addToBasket('price_1TIxqLAhb23PF7gKoRjh9Pqu', 'Friction Cups', 15)">Add to basket – £15 + £4 P&P</button>

## Curved shims for Aero Screen mirrors
![gaskets](https://img.uberniche.co.uk/gasket.jpeg)<br/>
![gaskets](https://img.uberniche.co.uk/three-gaskets.jpeg)<br/>
...
<button onclick="addToBasket('price_1TIxqMAhb23PF7gKdV9QFq2D', 'Curved Shims', 15)">Add to basket – £15 + £4 P&P</button>
